Private Sub btn_CancelarFinalizarExerce_Click()

Unload UserForm_FinalizarExerce
...
If ActiveCell.Offset(1, 0).Value = "" And numero3 >= "0" And numero2 >= "0" And numero > "0" And cb_NIVELDEDIFICULDADEEXERCE <> "" And numero = numero2 + numero3 And ActiveCell.Offset(1, 3).Value = "" Then
ActiveCell.Offset(0, 3).Value = Time$
ActiveCell.Offset(0, 12).Value = cb_NIVELDEDIFICULDADEEXERCE
ActiveCell.Offset(0, 14).Value = PageF
ActiveCell.Offset(0, 9).Value = numero

If numero3 > 0 Then
ActiveCell.Offset(0, 8).Value = numero3
Else
ActiveCell.Offset(0, 8).Value = "0"
End If

If numero2 > 0 Then
ActiveCell.Offset(0, 7).Value = numero2
Else
...
End If
Unload UserForm_FinalizarExerce
ElseIf cb_NIVELDEDIFICULDADEEXERCE = "" Then
MsgBox ("ERRO" & Chr(13) & "Todos os campos não foram preenchidos!")
ElseIf numero <> numero2 + numero3 Then
MsgBox ("ERRO" & Chr(13) & "O número de acertos com o de erros, não condiz com o número de questões!")
ElseIf numero < 1 Then
MsgBox ("ERRO" & Chr(13) & "Impossível existir menos que uma questão!")
ElseIf numero2 + numero3 = 0 Then
MsgBox ("ERRO" & Chr(13) & "Você não preencheu todos os campos corretamente!")
End If
